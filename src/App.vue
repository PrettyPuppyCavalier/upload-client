  ...
  <div class="container">
    ...
    <div class="operation">
      <a-button type="primary">
        主线程文件分片
        <input type="file" multiple @change="handleSingleCutFiles"/>
      </a-button>
      <a-button type="primary">
        多线程文件分片
        <input type="file" multiple @change="handleMultithreadingCutFiles"/>
      </a-button>
      <a-button type="primary">
        选择文件
...
const handleSingleCutFiles = (e) => {
  singleCutFiles(...e.target.files)
}

const handleMultithreadingCutFiles = (e) => {
  multithreadingCutFiles(...e.target.files)
}
</script>
